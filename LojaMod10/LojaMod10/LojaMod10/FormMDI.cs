...
//Nome - Paulo Barreira, Utilizador - Admin, password - dor | Quando fizer login vai aparecer a página
//de login outra vez, é um bug que eu não consegui resolver. Feche esse novo Form e continue a
//explorar o programa.😁
    ...
    public partial class FormMDI : Form
    {
        ...
        private void GerenciarCliqueLabel()                                                //GerenciarCliqueLabel
        {
            ...
            else
            {
                ...
                {
                    nomeUtilizador = null; // Limpe as credenciais
        ...
        private void ExibirFormLogin()                                               //ExibirFormLogin
        {
            using (FormLogin formLogin = new FormLogin())
            {
                if (formLogin.ShowDialog() == DialogResult.OK)
                {
                    ...
                    nomeUtilizador = formLogin.NomeUtilizador;
                    AtualizarLabels();
                }
            }
        }
        private void AtualizarLabellogin2()                                              //AtualizarLabelUsuario
        {
            ...
            lbllogin.Text = string.IsNullOrEmpty(nomeUtilizador) ? "Clique para fazer login" : "Olá, " + "Paulo Barreira";
        ...
        private void AtualizarLabels()
        {
            ...
            lbllogin.Visible = string.IsNullOrEmpty(nomeUtilizador);
            lbllogin2.Visible = !string.IsNullOrEmpty(nomeUtilizador);
            lbllogin2.Text = string.IsNullOrEmpty(nomeUtilizador) ? "" : "Olá, " + "Paulo Barreira";

            menuStrip1.Enabled = !string.IsNullOrEmpty(nomeUtilizador);
            toolStrip1.Enabled = !string.IsNullOrEmpty(nomeUtilizador);
        }
